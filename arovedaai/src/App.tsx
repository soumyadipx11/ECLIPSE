...
function AppContent() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden text-slate-900 dark:text-slate-100 font-sans transition-colors duration-200">
      ...
      <div className="fixed inset-0 bg-gradient-to-tr from-slate-100 via-rose-50/20 to-blue-50/40 dark:from-[#080d1a] dark:via-[#0c1224] dark:to-[#150a14] pointer-events-none z-0" />
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#ec003f]/30 to-[#ff2b66]/10 dark:from-[#ec003f]/35 dark:to-[#ff2b66]/15 blur-[120px]" />
        <div className="absolute bottom-[10%] left-[-15%] w-[550px] h-[550px] rounded-full bg-gradient-to-tr from-rose-500/10 to-indigo-500/10 dark:from-rose-900/15 dark:to-indigo-950/15 blur-[130px]" />
        <div className="absolute top-[40%] right-[5%] w-[450px] h-[450px] rounded-full bg-gradient-to-bl from-amber-500/10 to-rose-600/20 dark:from-amber-950/10 dark:to-[#ec003f]/25 blur-[110px]" />
      </div>
